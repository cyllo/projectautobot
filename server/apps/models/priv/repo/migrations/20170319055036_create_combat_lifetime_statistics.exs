defmodule Models.Repo.Migrations.CreateCombatLifetimeStatistics do
  ...
  def change do
    create table(:combat_lifetime_statistics) do
      ...
      add :weapon_accuracy_percentage, :decimal, null: false, default: 0
      add :critical_hits_accuracy_percentage, :decimal, null: false, default: 0
      ...
      add :scoped_accuracy_percentage, :decimal, null: false, default: 0
