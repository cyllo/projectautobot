...
export class HeroPortraitComponent implements OnInit {
  ...
  public ngOnInit() {
    ...
    this.owHeroData.data$.subscribe(
      ...
      () => {
        let hero: any;
        hero = heroData['heroes'].find(({
          code
        }) => code === this.owCode);
        this.heroName = hero.name;
        this.heroThumbnailUrl = hero.portraitUrl;
        this.heroRouteUrl = './hero/' + this.escapeString(this.removeWhiteSpace(this.removeDiacritics(hero.name))).toLowerCase();
      }
    );
  }
  ...
  removeDiacritics(str) {
    ...
    for (const x of Object.keys(diacriticsMap)) {
